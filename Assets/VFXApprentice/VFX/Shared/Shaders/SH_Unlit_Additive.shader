...
Shader "VFXA/Shared/SH_Unlit_Additive"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_TX_Color("TX_Color", 2D) = "white" {}
		_Color_Strength("Color_Strength", Float) = 1
		[Toggle(_USEDYNAMICCOLORSTRENGTH_ON)] _UseDynamicColorStrength("UseDynamicColorStrength", Float) = 0
		[Toggle(_USEDEPTHFADE_ON)] _UseDepthFade("UseDepthFade", Float) = 0
		[ASEEnd]_Depth_Fade_Strength("Depth_Fade_Strength", Range( 0 , 1)) = 0.333
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USEDYNAMICCOLORSTRENGTH_ON
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_TX_Color = IN.ase_texcoord3.xyz.xy * _TX_Color_ST.xy + _TX_Color_ST.zw;
				float3 texCoord14 = IN.ase_texcoord3.xyz;
				texCoord14.xy = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _USEDYNAMICCOLORSTRENGTH_ON
				float staticSwitch15 = texCoord14.z;
				#else
				float staticSwitch15 = _Color_Strength;
				#endif
				...
				float distanceDepth26 = abs( ( screenDepth26 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Depth_Fade_Strength ) );
				#ifdef _USEDEPTHFADE_ON
				float staticSwitch22 = saturate( distanceDepth26 );
				#else
				...
				float3 Color = ( ( IN.ase_color * tex2D( _TX_Color, uv_TX_Color ) ) * staticSwitch15 * staticSwitch22 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
226;676;1809;693;1975.495;-361.0759;1;True;False
Node;AmplifyShaderEditor.StaticSwitch;15;-971.5104,421.6425;Inherit;False;Property;_UseDynamicColorStrength;UseDynamicColorStrength;2;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;22;-969.8094,670.706;Inherit;False;Property;_UseDepthFade;UseDepthFade;3;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;26;-1339.495,757.0759;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1646.556,719.6082;Inherit;False;Property;_Depth_Fade_Strength;Depth_Fade_Strength;4;0;Create;True;0;0;0;False;0;False;0.333;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-1308.491,229.3394;Inherit;True;Property;_TX_Color;TX_Color;0;0;Create;True;0;0;0;False;0;False;-1;None;933ca54a6943e944bad78d7fbadd8011;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1231.909,501.8423;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;27;-1102.495,757.0759;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;12;-1180.61,58.64179;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;-1177.559,669.5571;Inherit;False;Constant;_Depth_Fade;Depth_Fade;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1196.909,422.8421;Inherit;False;Property;_Color_Strength;Color_Strength;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-898.4097,208.9418;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-530.7087,204.9406;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=EF8238B358E326D402E45ECDE1B97A590BAEB4A4