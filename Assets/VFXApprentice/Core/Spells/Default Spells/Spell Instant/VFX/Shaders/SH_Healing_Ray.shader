...
Shader "VFXA/Healing Spell/SH_Healing_Ray"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_Outer_Tint("Outer_Tint", Color) = (1.498039,0,1.45098,1)
		_Contrast("Contrast", Float) = 0
		_Ray_Threshold("Ray_Threshold", Float) = 0.045
		_Ray_Fall_Off("Ray_Fall_Off", Float) = 0.4
		_Ground_Mask_Strength("Ground_Mask_Strength", Float) = 10
		_Ground_Mask_Contrast("Ground_Mask_Contrast", Float) = 5
		[ASEEnd]_Depth_Fade("Depth_Fade", Range( 0 , 5)) = 0.333
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Outer_Tint;
			float _Contrast;
			float _Ray_Threshold;
			float _Ray_Fall_Off;
			float _Ground_Mask_Strength;
			float _Ground_Mask_Contrast;
			float _Depth_Fade;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float3 texCoord28 = IN.ase_texcoord3.xyz;
				texCoord28.xy = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_1_0_g3 = _Contrast;
				float2 texCoord20 = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_1 = (sin( ( PI * texCoord20.x ) )).xx;
				float lerpResult6_g3 = lerp( ( 0.0 - temp_output_1_0_g3 ) , ( temp_output_1_0_g3 + 1.0 ) , (temp_cast_1).y);
				float4 lerpResult26 = lerp( float4( (_Outer_Tint).rgb , 0.0 ) , (IN.ase_color).rgba , saturate( lerpResult6_g3 ));
				
				float2 texCoord11 = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult14 = smoothstep( _Ray_Threshold , ( _Ray_Threshold + _Ray_Fall_Off ) , ( ( 1.0 - texCoord11.x ) * texCoord11.x ));
				float2 texCoord35 = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float distanceDepth48 = abs( ( screenDepth48 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Depth_Fade ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( texCoord28.z * lerpResult26 ).rgb;
				float Alpha = saturate( ( IN.ase_color.a * ( ( ( 1.0 - texCoord20.y ) * smoothstepResult14 ) * saturate( pow( ( texCoord35.y * _Ground_Mask_Strength ) , _Ground_Mask_Contrast ) ) ) * saturate( distanceDepth48 ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * ( ( ( 1.0 - texCoord20.y ) * smoothstepResult14 ) * saturate( pow( ( texCoord35.y * _Ground_Mask_Strength ) , _Ground_Mask_Contrast ) ) ) * saturate( distanceDepth48 ) ) );
...
/*ASEBEGIN
Version=18935
188;629;1766;740;1577.431;-518.9471;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;47;-1496.371,-241.0659;Inherit;False;1222.888;972.2991;Alpha;22;11;38;35;16;12;15;17;39;36;20;13;37;19;14;40;34;21;25;24;22;23;18;;0.2745098,0.2745098,0.2745098,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1446.371,138.7965;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-1211.68,350.9341;Inherit;False;Property;_Ray_Fall_Off;Ray_Fall_Off;3;0;Create;True;0;0;0;False;0;False;0.4;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;-1289.265,455.8011;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-1310.265,577.8008;Inherit;False;Property;_Ground_Mask_Strength;Ground_Mask_Strength;4;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1223.68,252.9341;Inherit;False;Property;_Ray_Threshold;Ray_Threshold;2;0;Create;True;0;0;0;False;0;False;0.045;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;12;-1232.371,120.7965;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;46;-1020.972,753.5867;Inherit;False;757.3004;205.1656;Depth Fade;3;49;48;44;;0.2745098,0.2745098,0.2745098,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-1036.266,504.8011;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-1087.68,138.9341;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-1028.68,332.9341;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;-1081.68,-29.06593;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;39;-1061.265,607.8008;Inherit;False;Property;_Ground_Mask_Contrast;Ground_Mask_Contrast;5;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;19;-859.6794,81.9341;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-998.9716,824.5867;Inherit;False;Property;_Depth_Fade;Depth_Fade;6;0;Create;True;0;0;0;False;0;False;0.333;0.333;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;37;-815.2648,504.8011;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;14;-881.6794,232.9341;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-655.6794,163.9341;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;33;-615.1964,-653.3642;Inherit;False;1072.515;400.667;Color;7;28;27;30;32;31;29;26;;0.2745098,0.2745098,0.2745098,1;0;0
Node;AmplifyShaderEditor.DepthFade;48;-678.0696,805.5385;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;-661.2647,505.8011;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;31;-525.7614,-424.8119;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-470.7847,158.8347;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;49;-414.9276,806.3478;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;122.1075,-143.8166;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PiNode;22;-1048.68,-108.0659;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-844.6794,-108.0659;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;42;281.6685,-143.8168;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;30;-328.5868,-603.3639;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;56.73734,-599.0589;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;24;-562.6795,-133.0659;Inherit;False;SF_CheapContrast;-1;;3;d89899383d0a06b47904d500bdd99029;0;2;1;FLOAT;0;False;11;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;282.7601,-468.5009;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SinOpNode;23;-705.6794,-109.0659;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;32;-328.5871,-429.1937;Inherit;False;True;True;True;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;29;-565.1964,-603.3642;Inherit;False;Property;_Outer_Tint;Outer_Tint;0;1;[HDR];Create;True;0;0;0;False;0;False;1.498039,0,1.45098,1;0,0.8313726,1.498039,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;25;-725.6794,-191.0659;Inherit;False;Property;_Contrast;Contrast;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;26;-69.99013,-445.744;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1A4EEF5E12BC717DC5BA29550A1D5EC8D1B85A5D