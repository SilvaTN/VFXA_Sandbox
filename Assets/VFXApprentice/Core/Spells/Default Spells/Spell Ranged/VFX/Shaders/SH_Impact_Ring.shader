...
Shader "VFXA/Magic Missile/SH_Impact_Ring"
{
	Properties
	{
		...
		[ASEEnd]_Dissolve_Softness("Dissolve_Softness", Range( 0 , 0.5)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float temp_output_11_9 = IN.ase_texcoord3.x;
				float2 texCoord17 = IN.ase_texcoord4.xy * float2( 2,1 ) + float2( 0,0 );
				float2 appendResult14 = (float2(( IN.ase_texcoord4.z + IN.ase_texcoord4.w ) , 0.0));
				float smoothstepResult20 = smoothstep( temp_output_11_9 , ( temp_output_11_9 + _Dissolve_Softness ) , tex2D( _TextureSample0, ( texCoord17 + appendResult14 ) ).r);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = IN.ase_color.rgb;
				float Alpha = ( IN.ase_color.a * smoothstepResult20 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_11_9 = IN.ase_texcoord2.x;
				float2 texCoord17 = IN.ase_texcoord3.xy * float2( 2,1 ) + float2( 0,0 );
				float2 appendResult14 = (float2(( IN.ase_texcoord3.z + IN.ase_texcoord3.w ) , 0.0));
				float smoothstepResult20 = smoothstep( temp_output_11_9 , ( temp_output_11_9 + _Dissolve_Softness ) , tex2D( _TextureSample0, ( texCoord17 + appendResult14 ) ).r);
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_11_9 = IN.ase_texcoord.x;
				float2 texCoord17 = IN.ase_texcoord1.xy * float2( 2,1 ) + float2( 0,0 );
				float2 appendResult14 = (float2(( IN.ase_texcoord1.z + IN.ase_texcoord1.w ) , 0.0));
				float smoothstepResult20 = smoothstep( temp_output_11_9 , ( temp_output_11_9 + _Dissolve_Softness ) , tex2D( _TextureSample0, ( texCoord17 + appendResult14 ) ).r);
				
				surfaceDescription.Alpha = ( IN.ase_color.a * smoothstepResult20 );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_11_9 = IN.ase_texcoord1.x;
				float2 texCoord17 = IN.ase_texcoord2.xy * float2( 2,1 ) + float2( 0,0 );
				float2 appendResult14 = (float2(( IN.ase_texcoord2.z + IN.ase_texcoord2.w ) , 0.0));
				float smoothstepResult20 = smoothstep( temp_output_11_9 , ( temp_output_11_9 + _Dissolve_Softness ) , tex2D( _TextureSample0, ( texCoord17 + appendResult14 ) ).r);
...
/*ASEBEGIN
Version=18935
0;73;1920;968;2032.348;507.3883;1;True;False
Node;AmplifyShaderEditor.FunctionNode;11;-1323.121,27.31189;Inherit;False;SF_CustomVertexStreams;-1;;1;c056d1337072ded4986ee0ad6d782252;0;0;5;FLOAT4;0;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10
Node;AmplifyShaderEditor.RangedFloatNode;15;-926.9497,142.442;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-914.9497,50.44202;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-850.9497,-83.55798;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;14;-769.9497,50.44202;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;27;-1007.95,255.442;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;26;-1006.95,233.442;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-595.9497,-34.55798;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-618.4354,320.2119;Inherit;False;Property;_Dissolve_Softness;Dissolve_Softness;2;0;Create;True;0;0;0;False;0;False;0.1;0;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;28;-341.9497,211.442;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;18;-457.9497,-63.55798;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;74c43cfdc62211c4787f755c637e107e;74c43cfdc62211c4787f755c637e107e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-338.9497,246.442;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;31;-156.6425,-172.422;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;20;-155.9497,54.44202;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;79.25745,-25.02203;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;377.2698,-1.531548;Inherit;False;Property;_Cull;Cull;1;1;[Enum];Create;True;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;265.2,-172.8;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;VFXA/Magic Missile/SH_Impact_Ring;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;1;True;10;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;2;Include;;False;;Native;Define;REQUIRES_VERTEX_SHADOW_COORD_INTERPOLATOR;False;;Custom;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637916040600143503;  Blend;0;0;Two Sided;2;637916040626247255;Cast Shadows;0;637916040642246856;  Use Shadow Threshold;0;0;Receive Shadows;0;637916040655168614;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.CommentaryNode;19;-1370.121,-26.68811;Inherit;False;322;247;X: Scroll | Y: Random offset | Z: Dissolve;0;;0.2745098,0.2745098,0.2745098,1;0;0
WireConnection;13;0;11;7
WireConnection;13;1;11;8
WireConnection;14;0;13;0
WireConnection;14;1;15;0
WireConnection;27;0;11;9
WireConnection;26;0;11;9
...
ASEEND*/
//CHKSM=C1D0164659FFC98EE98C3F13739AA0F40DBC4C1E